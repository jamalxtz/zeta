...
class MainController extends UserLogin
{
	 ...
	 * $elementosHeader
	 *
	 * Array que armazena os elementos do Header (includes individuais de cada página)
	 *
	 * @access public
	 */
	public $elementosHeader;

	/**
	 * $elementosFooter
	 *
	 * Array que armazena os elementos do Footer (includes individuais de cada página)
	 *
	 * @access public
	 */
	public $elementosFooter;
